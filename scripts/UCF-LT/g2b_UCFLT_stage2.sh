#!/bin/bash
#SBATCH --job-name=UCFLT_stage2
#SBATCH --output=output/UCFLT/stage2/logs/%j.out
#SBATCH --error=output/UCFLT/stage2/logs/%j.err
#SBATCH --ntasks=1
...
OUTPUT_DIR='output/UCFLT/stage2/'
...
MODEL_PATH='output/UCFLT/stage1/checkpoint-stage1.pth'
