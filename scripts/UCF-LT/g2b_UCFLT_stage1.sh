#!/bin/bash
#SBATCH --job-name=UCFLT_stage1
#SBATCH --output=output/UCFLT/stage1/logs/%j.out
#SBATCH --error=output/UCFLT/stage1/logs/%j.err
#SBATCH --ntasks=1
...
OUTPUT_DIR='output/UCFLT/stage1/'
# Path to annotation files (train.csv/test.csv)
DATA_PATH='data/annotations/UCF-LT/balanced'
