#!/bin/bash
#SBATCH --job-name=UCFLT_eval
#SBATCH --output=output/UCFLT/stage2/eval/logs/%j.out
#SBATCH --error=output/UCFLT/stage2/eval/logs/%j.err
#SBATCH --ntasks=1
...
OUTPUT_DIR='output/UCFLT/stage2/eval/'
# Path to annotation files (train.csv/test.csv)
DATA_PATH='data/annotations/UCF-LT/real'
# Path to UCFLT stage 2 checkpoint for evaluation
MODEL_PATH='output/UCFLT/stage2/checkpoint-stage2.pth' # Adjust this path to your actual checkpoint
