#!/bin/bash
#SBATCH --job-name=RareActK100LT_stage2
#SBATCH --output=output/RareActK100LT/stage2/logs/%j.out
#SBATCH --error=output/RareActK100LT/stage2/logs/%j.err
#SBATCH --ntasks=1
...
OUTPUT_DIR='output/RareActK100LT/stage2/'
# Path to annotation files (train.csv/test.csv)
DATA_PATH='data/annotations/RareAct-K100-LT/real'
# Path to stage 1 checkpoint for stage 2 finetuning
MODEL_PATH='output/RareActK100LT/stage1/checkpoint-stage1.pth'
