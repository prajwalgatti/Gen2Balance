#!/bin/bash
#SBATCH --job-name=RareActK100LT_stage1
#SBATCH --output=output/RareActK100LT/stage1/logs/%j.out
#SBATCH --error=output/RareActK100LT/stage1/logs/%j.err
#SBATCH --ntasks=1
...
OUTPUT_DIR='output/RareActK100LT/stage1/'
# Path to annotation files (train.csv/test.csv)
DATA_PATH='data/annotations/RareAct-K100-LT/balanced'
