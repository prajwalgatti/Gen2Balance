#!/bin/bash
#SBATCH --job-name=RareActK100LT_eval
#SBATCH --output=output/RareActK100LT/stage2/eval/logs/%j.out
#SBATCH --error=output/RareActK100LT/stage2/eval/logs/%j.err
#SBATCH --ntasks=1
...
OUTPUT_DIR='output/RareActK100LT/stage2/eval/'
# Path to annotation files (train.csv/test.csv)
DATA_PATH='data/annotations/RareAct-K100-LT/real'
# Path to RareActK100LT stage 2 checkpoint for evaluation
MODEL_PATH='output/RareActK100LT/stage2/checkpoint-stage2.pth' # Adjust this path to your actual checkpoint
