#!/bin/bash
#SBATCH --job-name=K100LT_stage2
#SBATCH --output=output/K100LT/stage2/logs/%j.out
#SBATCH --error=output/K100LT/stage2/logs/%j.err
#SBATCH --ntasks=1
...
OUTPUT_DIR='output/K100LT/stage2/'
...
MODEL_PATH='output/K100LT/stage1/checkpoint-44.pth'
